...
# Process User Input and Generate Report
if submitted:
    ...
    prompt_template = pezzo.get_prompt("testESG")
    ...
    try:
        # Generate Response for the prompt template
        ...
        all_responses += f"\n\n{formatted_output}\n\n"  # Separate each response with newlines

    except Exception as e:
        error_message = str(e)
        all_responses += f"An error occurred while generating the report. Error details: {error_message}\n\n"
